...
export default function Home() {
  ...
  return (
    <>
      <section className="hero" style={{ backgroundImage: `linear-gradient(135deg, rgba(15,31,61,0.9) 0%, rgba(26,58,107,0.85) 50%, rgba(38,77,142,0.9) 100%), url(${HOMEPAGE_BG})`, backgroundSize: "cover", backgroundPosition: "center" }}>
        <div className="hero-content">
          <h1>Nottingham Economics & Finance Society</h1>
        ...
        <div className="container">
          ...
          <div className="stats-grid">
            <div className="stat-card">
              ...
              <h3>Members</h3>
              <p>Largest society at the University of Nottingham</p>
            </div>
            <div className="stat-card">
              <span className="stat-number">70+</span>
              <h3>Events</h3>
              <p>Hosted more than 70 events in the 2024/25 academic year</p>
            </div>
            <div className="stat-card">
              <span className="stat-number">8</span>
              <h3>Specialised Divisions</h3>
              <p>Focused on training our members to excel in their chosen field</p>
            </div>
            <div className="stat-card">
              <span className="stat-number">50</span>
              <h3>Years of History</h3>
              <p>First UoN Economics Society established in 1975</p>
            </div>
          </div>
        </div>
      </section>

      <section className="divisions" aria-label="Our Divisions">
        <div className="container">
          ...
          <div className="divisions-grid">
            {divisions.map((d) => (
              <Link key={d.slug} to={`/division/${d.slug}`} className="division-card">
